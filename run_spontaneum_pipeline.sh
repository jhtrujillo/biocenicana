#!/usr/bin/env bash
# run_spontaneum_pipeline.sh
# Integración automática de la Genómica Comparativa de Caña de Azúcar (CC-01-1940 vs S. spontaneum AP85-441)
set -e

echo "====================================================================="
echo "   INICIANDO PIPELINE DE INTEGRACIÓN CC-01-1940 vs S. SPONTANEUM     "
echo "====================================================================="

# Crear las carpetas destino
mkdir -p genomica_comparativa/1940_vs_spontaneum/tables
mkdir -p genomica_comparativa/1940_vs_spontaneum/plots
...
# 2. Cálculo de Ka/Ks
if [ ! -f genomica_comparativa/1940_vs_spontaneum/kaks_1940_vs_spontaneum.tsv ]; then
  ...
  java -jar target/biojava.jar kaks-calc \
    ...
    -o genomica_comparativa/1940_vs_spontaneum/kaks_1940_vs_spontaneum.tsv
else
...
java -jar target/biojava.jar comp-gen \
  ...
  --kaks genomica_comparativa/1940_vs_spontaneum/kaks_1940_vs_spontaneum.tsv \
  --viz genomica_comparativa/1940_vs_spontaneum/visor_sintenia.html \
  -o genomica_comparativa/1940_vs_spontaneum/reporte_comparativo.tsv \
  --name1 "S. spontaneum" \
  --name2 "CC 1940" \
  --organism Saccharum
...
./.venv/bin/python scripts/check_sucrose_genes.py \
  ...
  --report genomica_comparativa/1940_vs_spontaneum/reporte_comparativo.tsv \
  --kaks genomica_comparativa/1940_vs_spontaneum/kaks_1940_vs_spontaneum.tsv \
  --name1 "CC 1940" \
  --name2 "S. spontaneum"
...
./.venv/bin/python scripts/block_orientation.py \
  --report genomica_comparativa/1940_vs_spontaneum/reporte_comparativo.tsv \
  --output genomica_comparativa/1940_vs_spontaneum/tables/block_orientation.tsv

# B. Rangos de bloques
./.venv/bin/python scripts/compute_block_ranges.py \
  --report genomica_comparativa/1940_vs_spontaneum/reporte_comparativo.tsv \
  --output genomica_comparativa/1940_vs_spontaneum/tables/block_ranges.tsv
...
./.venv/bin/python scripts/sv_parser.py \
  ...
  genomica_comparativa/1940_vs_spontaneum/tables/sv_regions.bed
...
./.venv/bin/python scripts/sugar_snp_intersect.py \
  ...
  --report genomica_comparativa/1940_vs_spontaneum/reporte_comparativo.tsv \
  --output genomica_comparativa/1940_vs_spontaneum/tables/sugar_snp_overlap.tsv

# E. Enriquecimiento GO/KEGG
./.venv/bin/python scripts/go_enrichment.py \
  --orient genomica_comparativa/1940_vs_spontaneum/tables/block_orientation.tsv \
  --report genomica_comparativa/1940_vs_spontaneum/reporte_comparativo.tsv \
  --output genomica_comparativa/1940_vs_spontaneum/tables/go_enrichment.tsv \
  --organism sbicolor

# F. Intersección de bloques y SVs
./.venv/bin/python scripts/intersect_sv_blocks.py \
  --sv genomica_comparativa/1940_vs_spontaneum/tables/sv_regions.bed \
  --orient genomica_comparativa/1940_vs_spontaneum/tables/block_orientation.tsv \
  --output genomica_comparativa/1940_vs_spontaneum/tables/sv_block_overlap.tsv

# G. Gráficos interactivos en HTML (Plotly)
./.venv/bin/python scripts/interactive_plots.py \
  --orient genomica_comparativa/1940_vs_spontaneum/tables/block_orientation.tsv \
  --ranges genomica_comparativa/1940_vs_spontaneum/tables/block_ranges.tsv \
  --report genomica_comparativa/1940_vs_spontaneum/reporte_comparativo.tsv \
  --sugar-ids data/sugar_gene_ids.txt \
  --snp-ovl genomica_comparativa/1940_vs_spontaneum/tables/sugar_snp_overlap.tsv \
  --go-tsv genomica_comparativa/1940_vs_spontaneum/tables/go_enrichment.tsv \
  --out-dir genomica_comparativa/1940_vs_spontaneum/plots \
  --name1 "CC 1940" \
  --name2 "S. spontaneum"
...
./.venv/bin/python scripts/quantify_inversions.py \
  --ranges genomica_comparativa/1940_vs_spontaneum/tables/block_ranges.tsv \
  --orient genomica_comparativa/1940_vs_spontaneum/tables/block_orientation.tsv \
  --out-dir genomica_comparativa/1940_vs_spontaneum/tables

echo -e "\n====================================================================="
echo "   ¡INTEGRACIÓN COMPLETADA CON ÉXITO!                               "
echo "   - Reporte tabular: genomica_comparativa/1940_vs_spontaneum/reporte_comparativo.tsv"
echo "   - Visor HTML interactivo: genomica_comparativa/1940_vs_spontaneum/visor_sintenia.html"
echo "====================================================================="

		...
		while (iteratorRecords_tmp.hasNext()) {
			...
			for (int i = 0; i < genotypeCalls.size(); i++) {
				...
				if (idxCalledAlleles.length == 0) {
					...
					if (imputar.compareTo("dosagebsdp") == 0 || imputar.compareTo("dosagebsdpmoda") == 0 || imputar.compareTo("dosagebsdaverage") == 0) {	 //Imputo con el bsdp. Solo asigna si ambos alelos son mayores a cero. 
...
/*
	public static void main(String[] args) throws IOException {
		...
		//dosiscgene.genDosisAlelicas("/home/estuvar4/Downloads/cc-01-1940.vcf", 10, "dosagebsdaverage"); //imputa usando el bdsep, pero los que quedan con -1 los imputa con el promedio. 

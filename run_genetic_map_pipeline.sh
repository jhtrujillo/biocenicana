...
echo "    $OUT/mapa_biparental_final.map   — mapa genético (TSV)"
echo "    $OUT/visor_mapa_final.html        — visor interactivo"
echo "    $OUT/genes_en_mapa.tsv            — genes de sacarosa en el mapa"
echo ""
echo "  Para ver el mapa: abre el visor HTML en tu navegador"
